...
read_time: 5
fix_summary: "Flushing DNS (ipconfig /flushdns) and resetting TCP/IP stack (netsh int ip reset) clears the stale network state causing 'connected but no internet' on Ethernet — run both and restart."
