...
read_time: 5
fix_summary: "Open ALL access panels (front, back, and top) and check for small torn paper fragments near the rollers — a single shred of paper left behind keeps triggering the jam sensor."
