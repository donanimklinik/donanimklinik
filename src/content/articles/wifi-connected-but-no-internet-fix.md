...
read_time: 6
fix_summary: "Flushing DNS (ipconfig /flushdns) and resetting Winsock (netsh winsock reset) clears the stale network state causing 'connected but no internet' — run both commands and restart."
